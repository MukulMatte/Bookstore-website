...
function Signup() {
    ...
    const onSubmit = async (data) => {
        ...
        await axios.post("https://bookstore-websitebackend.onrender.com/user/signup", userInfo)
            .then((res) => {
                    ...
                    <div className='modal-box'>
                        <form onSubmit={handleSubmit(onSubmit)} method="dialog">
                            ...
                            <div className='mt-4 space-y-2 '>
                                <span>Gender</span>
                                <br />
                                <select className="select select-info max-w-xs w-80 px-3 py-2 border rounded-md outline-none"
